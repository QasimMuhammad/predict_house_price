...
# Must download file price_paid_records.csv from above kaggle link or uncomment to code 
# from line 30 to 36 to automatically download and extract but you don't want this each time you run the code. 
